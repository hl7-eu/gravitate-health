...
RuleSet: 49bbaf88ca82da246f516eabbf90d54eListRuleset


* identifier.system = "https://www.gravitatehealth.eu/sid/doc" 
* identifier.value = "acmedrug-xx"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "aquilea"

* status = #current
* mode = #working

* title = "List of all ePIs associated with aquilea"



* subject = Reference(mp3b8585822d27945de47423af5de9824d)
* subject.extension[0].url = "http://ema.europa.eu/fhir/extension/medicine-name"
* subject.extension[=].valueCoding = $100000000005#aquilea "aquilea"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-es-af1953635c28668e0d454e0740fcb36f) // Aquilea Articulacion es
...
Instance: List-af1953635c28668e0d454e0740fcb36f
InstanceOf: List

* insert 49bbaf88ca82da246f516eabbf90d54eListRuleset
