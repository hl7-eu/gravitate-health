...
InstanceOf: List
Usage: #example
Title: "List of flucelvax Package Leaflets"
Description: "List of flucelvax Package Leaflets"
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-04c9bd6fb89d38b2d83eced2460c4dc1) // dovato en
...
* entry
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-es-04c9bd6fb89d38b2d83eced2460c4dc1) // dovato en
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
