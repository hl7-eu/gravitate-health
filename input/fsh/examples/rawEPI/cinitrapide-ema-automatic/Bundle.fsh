...
// Ingredient
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Ingredient/ingredient-for-cinitrapide-magnesiumstearate"
* entry[=].resource = ingredient-for-cinitrapide-magnesiumstearate 


// Ingredient
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Ingredient/ingredient-for-cinitrapide-povidoneunspecified"
* entry[=].resource = ingredient-for-cinitrapide-povidoneunspecified 


// Ingredient
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Ingredient/ingredient-for-cinitrapide-cinitapride"
* entry[=].resource = ingredient-for-cinitrapide-cinitapride 


// Ingredient
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Ingredient/ingredient-for-cinitrapide-silicacolloidalanhydrous"
* entry[=].resource = ingredient-for-cinitrapide-silicacolloidalanhydrous 


// Ingredient
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Ingredient/ingredient-for-cinitrapide-starchpotato"
* entry[=].resource = ingredient-for-cinitrapide-starchpotato 


// Ingredient
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Ingredient/ingredient-for-cinitrapide-starchcorn"
...
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/AdministrableProductDefinition/ap-da0fc2395ce219262dfd4f0c9a9f72e1"
...
// Organization
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Organization/mah-94f8082c22713e050c3f2b55ea9d53ff"
* entry[=].resource = mah-94f8082c22713e050c3f2b55ea9d53ff 
...
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/MedicinalProductDefinition/mp1453e0f16ff6c1d3106ed737a7857578"
