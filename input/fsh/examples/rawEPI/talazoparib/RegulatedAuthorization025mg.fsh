...
Title: "Regulated Authorization for Talzenna® (talazoparib) 0.25 mg hard capsules"
Description: "Regulated Authorization for Talzenna® (talazoparib) 0.25 mg hard capsules"
Usage: #example
