...
RuleSet: 094b29cee867407552635ebcaf13f8c8ListRuleset


* identifier.system = "https://www.gravitatehealth.eu/sid/doc" 
* identifier.value = "xx"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "trastuzumab"

* status = #current
* mode = #working

* title = "List of all ePIs associated with trastuzumab"



* subject = Reference(mpaae8d931abe2f2d9085b87555b9bb088)
* subject.extension[0].url = "http://ema.europa.eu/fhir/extension/medicine-name"
* subject.extension[=].valueCoding = $100000000005#trastuzumab "trastuzumab"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-en-5af3df1132d20d744a88dab06e924e5e) // Ogivri 150 mg powder en
...
Instance: List-5af3df1132d20d744a88dab06e924e5e
InstanceOf: List

* insert 094b29cee867407552635ebcaf13f8c8ListRuleset
