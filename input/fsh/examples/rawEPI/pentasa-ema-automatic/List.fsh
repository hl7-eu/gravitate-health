...
RuleSet: 87263ad77afb6e39aa59e421ea0b6b37ListRuleset


* identifier.system = "https://www.gravitatehealth.eu/sid/doc" 
* identifier.value = "xx"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "pentasa"

* status = #current
* mode = #working

* title = "List of all ePIs associated with pentasa"
...
Instance: List-1a7318638ddbbeb084ef416e717b6fdb
InstanceOf: List

* insert 87263ad77afb6e39aa59e421ea0b6b37ListRuleset
