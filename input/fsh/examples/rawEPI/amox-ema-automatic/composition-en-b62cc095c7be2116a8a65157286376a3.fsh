...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p>Read all of this leaflet carefully before you start taking this medicine because it contains important
...
section 6)</li>
<li>if you have ever had an allergic reaction to any antibiotic. This can include a skin rash or swelling
...
<li>Lyme disease (an infection spread by parasites called ticks): Isolated erythema migrans (early
...
<ul>
<li>allergic reactions, the signs may include: skin itching or rash, swelling of the face, lips, tongue,
body or breathing difficulties. These can be serious and occasionally deaths have occurred</li>
<li>rash or pinpoint flat red round spots under the skin surface or bruising of the skin. This is due to
...
<li>a delayed allergic reaction can occur usually 7 to 12 days after having Amoxicillin Capsules, some
...
body aches</li>
<li>flu-like symptoms with a rash, fever, swollen glands, and abnormal blood test results (including
...
<li>the Jarisch-Herxheimer reaction which occur during treatment with Amoxicillin Capsules for Lyme
...
<ul>
<li>a middle itchy rash (round, pink-red patches), ‘hive-like’ swollen areas on forearms, legs, palms,
...
<li>Drug-induced enterocolitis syndrome (DIES): DIES has been reported mainly in children receiving
...
<li>Rash with blisters arranged in a circle with central crusting or like a string of pearls (linear
IgA disease)</li>
