...
Title: "Composition for Package leaflet: Xyntha® Lyophilized Powder for Reconstitution in a Vial"
Description:  "Composition for Package leaflet: Xyntha® Lyophilized Powder for Reconstitution in a Vial"
Usage: #example
...
* title = "Xyntha® Lyophilized Powder for Reconstitution in a Vial"
* language = #en
...
* section[+]
  ...
  * code = https://www.jordan.gov.jo/#100000155538
  * code.text = "ABOUT THIS MEDICATION"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'> 
<p>
        ...
        <p>Xyntha is produced in hamster cells and may contain trace amounts of hamster proteins.
            Patients who have a known history of allergic reactions to hamster proteins should not
            take Xyntha. Your doctor will advise you if you have had allergic reactions to hamster
            proteins.</p>
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>
  <table border="1">
            <tbody>
                ...
                <tr>
                    <td>
                        <p><b>Xyntha may cause
                                allergic reactions. Signs of allergy include hives (rash with
                                itching), swelling, chest tightness, difficulty breathing, wheezing,
                                faintness, and rapid heart rate. If any of these symptoms occur,
                                stop using Xyntha immediately and contact your hemophilia doctor or
                                seek emergency medical care. The initial infusions of Xyntha should
                                be administered under proper medical supervision, where proper
                                medical care for allergic reactions could be provided.</b></p>
                        <p><b>Notify your hemophilia doctor
                                if you are unable to prevent or control episodes of bleeding with
                                your normal dose of Xyntha.  Your body may produce inhibitors
                                against Xyntha. Inhibitors are antibodies produced by your immune
                                system that can prevent Xyntha from working properly. Check with
                                your hemophilia doctor to make sure you are closely monitored with
                                blood tests for the presence of inhibitors. </b></p>
                    </td>
                </tr>
            </tbody>
        </table>
...
* section[=].section[+]
  * title = "INTERACTIONS WITH THIS MEDICATION"
  * code = https://www.jordan.gov.jo/#100000155538
  * code.text = "INTERACTIONS WITH THIS MEDICATION"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'> 
        <p>No interactions of Xyntha with other medicinal products are known.</p>
  </div>"""

* section[+]
  * title = "PROPER USE OF THIS MEDICATION"
  * code = https://www.jordan.gov.jo/#100000155538
  * code.text = "PROPER USE OF THIS MEDICATION"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'> 
<p>You should always follow the specific instructions given by your hemophilia doctor. </p>
        <p>The steps listed below are general guidelines for using Xyntha<sup>. </sup> If you are
            unsure of the procedures, please call your hemophilia doctor or nurse before using. </p>
        <p>Your hemophilia doctor will decide the dose of Xyntha you will receive. The dose and
            duration of Xyntha treatment will depend on your individual need for replacement factor
            VIII therapy. </p>
        <p>Your hemophilia doctor may decide to change your dose of Xyntha. In the presence of an
            inhibitor, you may need higher doses or specific treatment. Contact your hemophilia
            doctor or nurse immediately if bleeding is not controlled after using Xyntha.</p>
        <p> Do not stop taking Xyntha or lower your dose, without checking with your hemophilia
            doctor, unless you think you are having an allergic reaction.</p>
        <p>Your doctor may occasionally need to take blood tests to make sure that the level of
        ...
        <p>Xyntha is supplied in a sterile, freeze-dried powder form, and it is intended for
            injection directly into your vein, usually either by yourself, your doctor, your
            hemophilia nurse, or other trained person.</p>
        <p>Before it can be injected, the powder must be dissolved with the liquid diluent supplied
            (0.9% sodium chloride) to make it an injectable liquid. </p>
        <p>An infusion set (tubing and butterfly needle), sterile alcohol swabs, gauze pads and
            bandages are required. </p>
        <p>These devices are not included in the Xyntha Hospital package.</p>
        <p/>
        ...
        <p> Use only the materials provided in the Xyntha kit for dissolving the Xyntha powder with
            the sodium chloride diluent.</p>
        <p>All components used in the mixing and injection of Xyntha should be used as soon as
            possible after opening their sterile containers to minimize unnecessary exposure to room
            air.</p>
        <p>Xyntha is administered by intravenous injection after dissolving with the supplied
            diluent (0.9% sodium chloride) in the pre-filled syringe.</p>
        <p>Additional instructions for using Xyntha are provided after <b>INFUSION (Intravenous
                Injection)</b> that detail the use of a Xyntha Powder and Solvent for Solution for
            Injection.</p>
        <p>Note: If you use more than one vial of Xyntha per injection, each vial should be
            dissolved according to the following instructions. The empty syringe should be removed
            leaving the vial adapter in place, and a separate large luer lock syringe may be used to
            draw back the dissolved contents of each vial. Do not detach the diluent syringes or the
            large luer lock syringe until you are ready to attach the large luer lock syringe to the
            next vial adapter.</p>
        <p> </p>
        <ol>
        ...
        <p>Always wash your hands before doing the following procedures. Germ-free methods should be
            used during injection. If you need to use more than 1 vial to inject your prescribed
            dose, you must use a new alcohol swab for each vial. Do not use the injection needle to
            withdraw the medicine from vial. </p>
        <p>Xyntha should be administered using the pre-filled diluent syringe provided or a single
            ...
            <tbody>
                <tr>
                    <td>In case of drug overdose, contact a health care practitioner, hospital
                        emergency department or regional Poison Control Centre immediately, even if
...
* section[+]
  * title = "SIDE EFFECTS AND WHAT TO DO ABOUT THEM"
  * code = https://www.jordan.gov.jo/#100000155538
  * code.text = "SIDE EFFECTS AND WHAT TO DO ABOUT THEM"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'> 
<p>Xyntha may cause allergic reactions. </p>
        <p>Some side effects of Xyntha include cold sensation, chest pain, rapid heart beat,
            sweating, drowsiness, muscle weakness, loss of appetite, muscle pain, pain, coughing,
            shortness of breath, diarrhea, stomach cramps, altered taste, injection site pain or
            inflammation and weakness. </p>
        <p>Contact your hemophilia doctor immediately if your bleeding does not stop as
            expected.</p>
        <p>Your body can also produce inhibitors, or antibodies, against Xyntha, which may prevent
            Xyntha from working properly. If your bleeding is not controlled with the usual dose of
            Xyntha, call your hemophilia doctor or nurse. You should be monitored in order to find
            out whether a factor VIII inhibitor is present.</p>
        <p>These are not all the possible side effects of Xyntha. Call your hemophilia doctor or
            nurse right away if any side effect becomes serious, if you notice any side effects not
            listed in this leaflet, or if there is any other side effect that concerns you.</p>
        <p>Tell all your doctors, dentists, and pharmacists who are treating you that you are taking
            Xyntha.</p>
        <p>If you are about to start taking any new medication, tell your doctor and pharmacist that
...
<table border="1">
  ...
  <p><i>This is not a complete list of side effects.  For any unexpected effects while taking Xyntha, contact your doctor or hemophilia treatment center.</i></p>
  </div>"""

* section[+]
  * title = "HOW TO STORE IT"
  * code = https://www.jordan.gov.jo/#100000155538
  * code.text = "HOW TO STORE IT"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'> 
<p>Keep the freeze-dried Xyntha vial and the diluent syringe in the refrigerator at a
            temperature of 2° to 8°C.</p>
        <p>Xyntha may be stored at room temperature not above 25°C for up to 3 months and not to
            exceed the expiration date. You should write the date in the space provided on the outer
            carton when you first store Xyntha at room temperature. </p>
        <p>After room temperature storage, the product can be returned to refrigerated storage until
            the expiration date. Do not store Xyntha at room temperature and return it to
            refrigerated storage more than once.</p>
        <p>DO NOT freeze. </p>
        <p>DO NOT use after the expiration date (month and year) on the label, even if it has been
            stored properly.</p>
        <p>Avoid exposure of the Xyntha vials to light.</p>
        <p>Xyntha does not contain a preservative. Use the dissolved solution as soon as possible
            after mixing. If the solution is not used right away, it can be stored at room
            temperature and must be used within 3 hours. </p>
        <p>DO NOT use Xyntha if the dissolved solution is not clear to slightly pearly and
            colorless.</p>
        <p>Keep Xyntha (and needles) where young children cannot reach it.</p> 
  </div>"""

* section[+]
  * title = "MORE INFORMATION"
  * code = https://www.jordan.gov.jo/#100000155538
  * code.text = "MORE INFORMATION"
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'> 
<p>Last revised: April 2016</p>
        <p> </p>
        ...
        <p>Canada, H9J 2M5</p>
        <p> </p>
        <p><b>Manufactured, Packaged and Released By:</b></p>
        <p>Wyeth Farma S.A,</p>
