...
* subject = Reference(medprodcarbamazepine200) //reference to the medicinal product

* date = "2002-08-01T13:28:17Z"

* author = Reference(orgfujinaga)  // Reference to Organization: Marketing Authorization Holder
* title = "Tegretol (carbamazepine) 200 mg for tablet"
