...
RuleSet: 9aabab1dccc46a284a817edc09bfaddaListRuleset


* identifier.system = "https://www.gravitatehealth.eu/sid/doc" 
* identifier.value = "acmedrug-xx"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "naturesplus"

* status = #current
* mode = #working

* title = "List of all ePIs associated with naturesplus"



* subject = Reference(mp96d7b1b575aa8164c8c2b4cbe70f252a)
* subject.extension[0].url = "http://ema.europa.eu/fhir/extension/medicine-name"
* subject.extension[=].valueCoding = $100000000005#naturesplus "naturesplus"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundlepackageleaflet-es-b5a6ac2496348cb06663deb81c55cb37) // Natures Plus Spiru-T es
...
Instance: List-b5a6ac2496348cb06663deb81c55cb37
InstanceOf: List

* insert 9aabab1dccc46a284a817edc09bfaddaListRuleset
