...
Instance: composition-es-96d7b1b575aa8164c8c2b4cbe70f252a
...
* title = "TEST PURPOSES ONLY - Natures Plus Spiru-Tein"
...
* section[=].section[+]
  * title =  "1. Qué es Natures Plus Spiru-Tein y para qué se utiliza"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text =  "1. Qué es Natures Plus Spiru-Tein y para qué se utiliza"
  * text.status = #additional
...
* section[=].section[+]
  * title = "2. Qué necesita saber antes de empezar a tomar Natures Plus Spiru-Tein"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "2. Qué necesita saber antes de empezar a tomar Natures Plus Spiru-Tein"
  * text.status = #additional
...
* section[=].section[+]
  * title =  "3. Cómo tomar Natures Plus Spiru-Tein"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "3. Cómo tomar Natures Plus Spiru-Tein"
  * text.status = #additional
...
* section[=].section[+]
  * title = "5. CONSERVACIÓN DE Natures Plus Spiru-Tein"
  * code = https://spor.ema.europa.eu/rmswi/#100000155538
  * code.text = "5. CONSERVACIÓN DE Natures Plus Spiru-Tein"
  * text.status = #additional
