...
Instance: composition-en-novorapid
...
Instance: himss-novorapid-mpd
InstanceOf: MedicinalProductDefinitionUvEpi
Title: "himss novorapid mpd"
Description: "himss novorapid mpd"
Usage: #inline
...
* name
  * productName = "Novorapid Flexpen 100 units/ml solution for injection in pre-filled pens"
  * type = $spor-productNamePartType-cs#220000000001 "Full name" 
  
  * part[0]
    * part = "Novorapid FlexPen"
...
RuleSet: novorapid-ruleset 


// Composition
* entry[+].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/himss-novorapid-mpd"
* entry[=].resource = himss-novorapid-mpd


Instance: bundle-novo-raw
...
// Composition
* entry[0].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/composition-en-novorapid"
* entry[0].resource = composition-en-novorapid
