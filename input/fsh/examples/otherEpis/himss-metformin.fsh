...
RuleSet: himms-metformin-ruleset


* identifier.system = "https://www.gravitatehealth.eu/sid/doc" 
* identifier.value = "xx"
* identifier[+].system = "http://spor.ema.europa.eu/v2/medicine-name"
* identifier[=].value = "metformin"

* status = #current
* mode = #working

* title = "List of all ePIs associated with metformin"



* subject = Reference(himss-metformin-mpd)
* subject.extension[0].url = "http://ema.europa.eu/fhir/extension/medicine-name"
* subject.extension[=].valueCoding = $100000000005#ibuprofen "metformin"
...
* entry[+]
  ...
  * flag.text = "Unchanged"
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundle-met-raw) // amoxicillin 250 mg t en
...
* entry[+]
  ...
  * date = "2015-02-07T13:28:17Z"
  * item = Reference(bundle-met-proc) // amoxicillin 250 mg t en
  * item.extension[0].url = "http://ema.europa.eu/fhir/extension/documentType"
  * item.extension[=].valueCoding = $100000155531#100000155538 "B. PACKAGE LEAFLET"
  * item.extension[+].url = "http://ema.europa.eu/fhir/extension/language"
  //* item.extension[=].valueCoding = $100000072057#100000072147 "English"
...
Instance: List-metformin-himms
InstanceOf: List

* insert himms-metformin-ruleset