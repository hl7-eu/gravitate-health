...
* entry[+].fullUrl = "Organization/man-4bb7a752921434fd5f9921b5b9473eda"
...
Instance: composition-processed-pt-f4d45353edcb21af3718d3a0df94a4d8
InstanceOf: CompositionUvEpi
...
* identifier.value = "karvea-pt-processed"
* status = #final
...
pressão arterial elevada e diabetes do tipo 2.</p>
<div class="indication"> <p>Karvea é usado em doentes adultos</p>
<ul>
...
<p><strong><span class="lactose">Karvea contém lactose.</span> </strong>Se foi informado pelo seu médico de que é intolerante a alguns açúcares (por
...
// Composition
* entry[0].fullUrl = "Composition/composition-processed-pt-f4d45353edcb21af3718d3a0df94a4d8"
