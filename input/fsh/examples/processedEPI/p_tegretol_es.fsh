Instance: composition-es-proc-ac2bb08bb4cc3f51f8c4e3513034c019
...
* section[=].section[+]
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <div>
    ...
    <ul>
      ...
      <li><span >Si tiene problemas en la formación de porfirina, pigmento importante para la función hepática y la formación de sangre (también llamada porfiria hepática);</span></li>
    ...
    <ul>
      ...
      <li><span >Si tiene problemas de riñón asociados con bajos niveles de sodio en sangre o si tiene problemas de riñón y está tomando medicinas que le bajen los niveles de sodio en sangre (diuréticos como hidroclorotiazida, furosemida).</span></li>
    ...
    <p><span >1. Si desea quedarse embarazada, planifique sus embarazos consultando con sus especialistas.</span></p>
...
* section[=].section[+]
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <div>
    ...
    <p><span >En caso de sobredosis por Tegretol, comuníquelo inmediatamente a su médico. Puede necesitar atención médica. Si experimenta dificultad respiratoria, ritmo cardíaco rápido e irregular, pérdida de conocimiento, temblores, mareos, náuseas y/o vómitos puede que esté tomando una dosis demasiado alta de Tegretol. Informe inmediatamente al médico.</span></p>
...
Instance: bundlepackageleaflet-es-proc-2f37d696067eeb6daf1111cfc3272672
...
// Composition
* entry[0].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/composition-es-proc-ac2bb08bb4cc3f51f8c4e3513034c019"
* entry[0].resource = composition-es-proc-ac2bb08bb4cc3f51f8c4e3513034c019
