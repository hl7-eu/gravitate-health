...
Instance: composition-en-novorapid-proc
...
* identifier.value = "himss-novorapid-proc"
* status = #final
...
<p class="pregnancyCategory">Pregnancy and breast-feeding </p>
<p class="pregnancyCategory">If you are pregnant, think you may be pregnant or are planning to have a baby, ask your doctor 
...
<p class="pregnancyCategory">There are no restrictions on treatment with NovoRapid during breast-feeding. </p>
<p class="pregnancyCategory">Ask your doctor, nurse or pharmacist for advice before taking this medicine while pregnant or breast-
feeding. </p>
...
Instance: bundle-novo-proc
InstanceOf: BundleUvEpi
Title: "ePI document Bundle for Novorapid Flexpen 100 units/ml solution for injection in pre-filled pen Package Leaflet for language en"
Description: "ePI document Bundle for Novorapid Flexpen 100 units/ml solution for injection in pre-filled pen Package Leaflet for language en"
Usage: #example


* identifier.system = "https://www.gravitatehealth.eu/sid/doc" 
* identifier.value = "himss-novorapid"
* type = #document
...
// Composition
* entry[0].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/composition-en-novorapid-proc"
* entry[0].resource = composition-en-novorapid-proc
