Instance: composition-en-2a9c4333cfd126f2e7b73ad3cafd6949-pproc
...
* extension[=].extension[=].valueCodeableReference.concept.coding = $sct#86406008 "HIV infection"
...
* extension[=].extension[=].valueString = "hiv"
* extension[=].extension[+].url = "concept"
* extension[=].extension[=].valueCodeableReference.concept.coding = $sct#19030005 "Human immunodeficiency virus"
...
* section[+].
  ...
  * text.div = """
<html><body><div xmlns="http://www.w3.org/1999/xhtml"> <p><strong>Read all of this leaflet carefully before you start taking this medicine because it contains
...
is addressed to your child (in this case please read “your child” instead of “you”).</strong></p> </div></body></html>
"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """
<html><body><div xmlns="http://www.w3.org/1999/xhtml"> <p>Biktarvy contains three active substances:</p>
<ul>
<li>bictegravir, an antiretroviral medicine known as an integrase strand transfer inhibitor (INSTI)</li>
<li class="difficult">emtricitabine, an antiretroviral medicine of a type known as a nucleoside reverse transcriptase
inhibitor (NRTI)</li>
<li class="difficult">tenofovir alafenamide, an antiretroviral medicine of a type known as a nucleotide reverse
transcriptase inhibitor (NtRTI)</li>
</ul>
<p class="children jonwort hiv">Biktarvy is a single tablet for the treatment of human immunodeficiency virus 1 (HIV-1) infection in
adults, adolescents and children 2 years of age and older, who weigh at least 14 kg.</p>
<p class="hiv">Biktarvy reduces the amount of HIV in your body. This will improve your immune system and reduce
the risk of developing illnesses linked to HIV infection.</p> </div></body></html>
"""   
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """
<html><body><div xmlns="http://www.w3.org/1999/xhtml"> <p><strong>Do not take Biktarvy</strong></p>
<ul>
...
<ul>
<li class="difficult">rifampicin used to treat some bacterial infections such as tuberculosis</li>
<li class="hperforatum">St. John’s wort (Hypericum perforatum), a herbal remedy used for depression and
...
<ul>
<li class="jonwort difficult">If you have liver problems or a history of liver disease, including hepatitis. Patients with
...
<li><p class="jonwort">If you have hepatitis B infection. Liver problems may become worse after you stop taking
Biktarvy.</p>
</li>
<li><p class="jonwort">Do not stop taking Biktarvy if you have hepatitis B. Talk to your doctor first. For more details, see
...
<ul>
<li class="difficult">Signs of inflammation or infection</li>
...
<p class="difficult">There is a possibility that you may experience kidney problems when taking Biktarvy over a long
period of time (see Warnings and precautions).</p>
<p class="hiv">This medicine is not a cure for HIV infection. While taking Biktarvy you may still develop infections
or other illnesses associated with HIV infection.</p>
<p class="children difficult"><strong>Children and adolescents</strong></p>
<p class="children">Do not give this medicine to children under 2 years of age, or weighing less than 14 kg regardless
...
<p class="children">Loss of bone mass has been reported in some children from 3 to less than 12 years of age who
...
<ul>
<li class="difficult">rifampicin used to treat some bacterial infections such as tuberculosis</li>
<li class="hperforatum">St. John’s wort (Hypericum perforatum), a herbal remedy used for depression and anxiety, or
...
<li class="difficult">adefovir dipivoxil, atazanavir, bictegravir, emtricitabine, lamivudine, tenofovir
alafenamide, or tenofovir disoproxil</li>
</ul>
</li>
<li class="difficult">antibiotics used to treat bacterial infections, containing:<ul>
<li>azithromycin, clarithromycin, rifabutin or rifapentine</li>
</ul>
</li>
<li>anticonvulsants used to treat epilepsy, containing:<ul>
<li class="difficult">carbamazepine, oxcarbazepine, phenobarbital or phenytoin</li>
</ul>
</li>
<li class="difficult">immunosuppressants used to control your body’s immune response after a transplant,
containing ciclosporin</li>
<li><p class="difficult">ulcer-healing medicines containing sucralfate</p>
</li>
...
<ul>
<li class="difficult">antacids to treat stomach ulcers, heartburn, or acid reflux, containing aluminium and/or
magnesium hydroxide</li>
<li class="difficult">mineral supplements or vitamins containing magnesium or iron</li>
...
<ul>
<li class="breastfeeding pregnancy">If you are pregnant or breast-feeding, think you may be pregnant or are planning to have a baby,
...
<p class="children pregnancy hiv difficult">If you have taken Biktarvy during your pregnancy, your doctor may request regular blood tests and
...
<p class="hiv breastfeeding"><strong>Do not breast-feed during treatment with Biktarvy.</strong> This is because some of the active substances
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """
<html><body><div xmlns="http://www.w3.org/1999/xhtml"> <p>Always take this medicine exactly as your doctor has told you. Check with your doctor or pharmacist
...
<p class="children">Children 2 years of age and older, who weigh at least 14 kg but less than 25 kg: one tablet each
day with or without food (one 30 mg/120 mg/15 mg tablet).</p>
<p class="difficult">Due to the bitter taste, it is recommended not to chew or crush the tablet.
...
<p class="difficult">The score line on the tablet is only there to help you break the tablet if your child has difficulty
swallowing it whole.</p>
<p class="pregnancy difficult">The 90-day multipack contains three 30-day packs together.</p>
<ul>
...
<p class="jonwort hiv">If you have both HIV infection and hepatitis B, it is especially important not to stop your Biktarvy
...
<ul>
<li class="jonwort">Tell your doctor immediately about new or unusual symptoms after you stop treatment,
...
<p class="difficult"><strong>Possible side effects: tell a doctor immediately</strong></p>
<ul>
<li class="hiv">Any signs of inflammation or infection. In some patients with advanced HIV infection
...
such as:<ul>
<li class="difficult">muscle weakness</li>
<li>weakness beginning in the hands and feet and moving up towards the trunk of the body</li>
<li class="difficult">palpitations, tremor or hyperactivity</li>
</ul>
</li>
<li class="difficult">If you notice these or any symptoms of inflammation or infection, tell your doctor
immediately.</li>
</ul>
<p><strong>Common side effects</strong>
(may affect up to 1 in 10 people)</p>
<ul>
<li class="difficult">depression</li>
<li class="difficult">abnormal dreams</li>
<li>headache</li>
<li class="difficult">dizziness</li>
<li class="difficult">diarrhoea</li>
<li>feeling sick (nausea)</li>
<li class="difficult">tiredness (fatigue)</li>
</ul>
<p class="difficult"><strong>Uncommon side effects</strong></p>
<p>(may affect up to 1 in 100 people)</p>
<ul>
<li>anaemia</li>
<li class="difficult">vomiting</li>
<li>stomach pain</li>
<li class="difficult">problems with digestion resulting in discomfort after meals (dyspepsia)</li>
<li class="difficult">wind (flatulence)</li>
<li>swelling of the face, lips, tongue or throat (angioedema)</li>
<li class="difficult">itching (pruritus)</li>
<li class="rash">rash</li>
<li class="hiv">hives (urticaria)</li>
<li>joint pain (arthralgia)</li>
<li class="difficult">suicidal thoughts and suicide attempt (particularly in patients who have had depression or
...
<p class="hiv"><strong>Other effects that may be seen during HIV treatment</strong></p>
...
<li class="difficult">difficulty with movement</li>
</ul>
</li>
<li>If you notice any of these symptoms tell your doctor.</li>
</ul>
<p class="hiv">During HIV therapy there may be an increase in weight and in levels of blood lipids and glucose. This
...
of this medicine.</p> </div></body></html>
"""      
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """
<html><body><div xmlns="http://www.w3.org/1999/xhtml"> <p><strong>What Biktarvy contains</strong></p>
...
<p class="difficult"><strong>The other ingredients are</strong><em>Tablet core</em>Microcrystalline cellulose (E460), croscarmellose sodium (E468), magnesium stearate (E470b).</p>
...
The silica gel desiccant is contained in a separate sachet or canister and should not be swallowed.</p> </div></body></html>
"""      
...
// Composition
* entry[0].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/composition-en-2a9c4333cfd126f2e7b73ad3cafd6949-pproc"
* entry[0].resource = composition-en-2a9c4333cfd126f2e7b73ad3cafd6949-pproc
