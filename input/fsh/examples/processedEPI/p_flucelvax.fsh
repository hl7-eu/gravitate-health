...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p><strong><span>Prospecto: informaci&#243;n para el usuario</span></strong></p>
    ...
    <p><strong><span>Flucelvax Tetra - suspensi&#243;n inyectable en jeringa precargada</span></strong></p>

    <p><span>Vacuna contra la gripe (ant&#237;geno de superficie, inactivado, preparada en cultivos celulares)</span></p>
    ...
    <p><strong><span>Lea todo el prospecto detenidamente antes de empezar a recibir este medicamento, porque contiene</span></strong> <strong><span>informaci&#243;n importante para usted.</span></strong></p>

    <p><span>-&#160;&#160;&#160;&#160;&#160;&#160;</span> <span>Conserve este prospecto, ya que puede tener que volver a leerlo.</span></p>
																			   

    <p><span>-&#160;&#160;&#160;&#160;&#160;</span> <span>Si tiene alguna duda, consulte a su m&#233;dico, farmac&#233;utico o enfermero.</span></p>

    <p><span>-</span><span>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</span> <span>Si experimenta efectos adversos, consulte a su m&#233;dico, farmac&#233;utico o enfermero, incluso si se trata de efectos adversos que no aparecen en este prospecto. Ver secci&#243;n 4.</span></p>
...
* section[=].section[+]
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p><strong><span>Contenido del prospecto</span></strong></p>
    ...
    <p><span>1.&#160;&#160;&#160; Qu&#233; es Flucelvax Tetra y para qu&#233; se utiliza</span></p>

    <p><span>2.&#160;&#160;&#160; Qu&#233; necesita saber antes de empezar a recibir Flucelvax Tetra</span></p>
														  
 

    <p><span>3.&#160;&#160;&#160; C&#243;mo se administra Flucelvax Tetra</span></p>

    <p><span>4.&#160;&#160;&#160; Posibles efectos adversos</span></p>
																	
 

    <p><span>5.&#160;&#160;&#160; Conservaci&#243;n de Flucelvax Tetra</span></p>

    <p><span>6.&#160;&#160;&#160; Contenido del envase e informaci&#243;n adicional</span></p></div>"""   
...
* section[=].section[+]
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p><span>&#xa0;</span></p>
    ...
    <p class="indication"><span>Flucelvax Tetra es una vacuna contra la gripe. Flucelvax Tetra se prepara en cultivos celulares y, por lo tanto, no contiene huevo.</span></p>
														   
 

    <p><span>Cuando una persona recibe la vacuna, el sistema inmunitario (el sistema de defensa natural del organismo) producir&#225; su propia protecci&#243;n frente al virus de la gripe. Ninguno de los componentes de la vacuna puede causar la gripe.</span></p>

    <p><span>&#xa0;</span></p>
														 
 

    <p><span>Flucelvax Tetra se usa para prevenir la gripe en adultos y ni&#241;os a partir de los 2 a&#241;os de edad.</span></p>

    <p><span>&#xa0;</span></p>

    <p><span>La vacuna va dirigida a cuatro cepas del virus de la gripe siguiendo las recomendaciones de la</span> <span>Organizaci&#243;n Mundial de la Salud para la campa&#241;a</span> <span>2023/2024.</span></p>        </div>"""   
...
* section[=].section[+]
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p><span>&#xa0;</span></p>
    ...
    <p><span>Los siguientes efectos adversos se han notificado durante los ensayos cl&#237;nicos y durante el uso general:</span></p>

    <p><span>&#xa0;</span></p>

    <p><strong><span>Efectos adversos muy graves</span></strong></p>

    <p><span>Consulte inmediatamente con su m&#233;dico o acuda al servicio de urgencias del hospital m&#225;s cercano si presenta el siguiente efecto adverso &#8211; puede necesitar urgentemente atenci&#243;n m&#233;dica u hospitalizaci&#243;n:</span></p>
    ...
    <p><strong><span>Efectos adversos graves</span></strong></p>

    <p><span>Informe inmediatamente a su m&#233;dico si presenta cualquiera de los efectos adversos siguientes &#8211; puede necesitar atenci&#243;n m&#233;dica:</span></p>
    ...
    <ul >
      ...
      <li><span>Dolor muscular</span></li>

      <li><span>Cansancio</span></li>

      <li><span>P&#233;rdida de apetito</span></li>

      <li><span>Irritabilidad (notificada solo en ni&#241;os de 2 a &#60; 6 a&#241;os)</span></li>

      <li><span>Somnolencia (notificada solo en ni&#241;os de 2 a &#60; 6 a&#241;os)</span></li>
    </ul>

    <p><span>En los pacientes de edad avanzada fueron frecuentes el endurecimiento o la hinchaz&#243;n en el lugar de la inyecci&#243;n, el dolor de cabeza, el dolor muscular y la fatiga.</span></p>

    <p><span>Los cardenales en el lugar de la inyecci&#243;n fueron frecuentes en adultos, ancianos y ni&#241;os de 9 a &#60; 18 a&#241;os.</span></p>

    <p><span>El dolor de cabeza fue frecuente en ancianos.</span></p>

    <p><span>La p&#233;rdida de apetito fue frecuente en adultos, ancianos y ni&#241;os de 9 a &#60; 18 a&#241;os.</span></p>
    ...
    <p><span>Los v&#243;mitos fueron poco frecuentes en los pacientes de edad avanzada</span></p>
...
* section[=].section[+]
  ...
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p><span>&#xa0;</span></p>
    ...
    <p><span>Cada jeringa individual contiene 0,5 ml de suspensi&#243;n inyectable.</span></p>

    <p><span>Flucelvax Tetra est&#225; disponible en envases de 1 jeringa precargada con o sin aguja o 10 jeringas</span></p>

    <p><span>precargadas con o sin agujas.</span></p>
    ...
    <p><span>Paasheuvelweg 28</span></p>

    <p><span>1105BJ Amsterdam</span></p>
