Instance: composition-en-d33868162d255ced115cecbbf188aab4-pproc
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """
<html><body><div xmlns="http://www.w3.org/1999/xhtml"> <p class="diabetes">Humalog is used to treat diabetes. Humalog works more quickly than normal human insulin because
the insulin molecule has been changed slightly.</p>
<p class="diabetes">You get diabetes if your pancreas does not make enough insulin to control the level of glucose in your
...
<p class="children jonwort">Humalog is suitable for use in adults and children.</p> </div></body></html>
"""   
...
glucose often.</li>
<li class="difficult">A few people who have had hypoglycaemia after switching from animal insulin to human insulin
...
<li class="diabetes">If you answer YES to any of the following questions, tell your doctor, pharmacist or diabetes
nurse<ul>
...
<li class="diabetes">You should also tell your doctor, pharmacist or diabetes nurse if you are planning to go abroad.
...
<li class="diabetes">Some patients with long-standing type 2 diabetes mellitus and heart disease or previous stroke
...
<ul>
<li class="difficult">the contraceptive pill,</li>
<li>steroids,</li>
<li class="difficult">thyroid hormone replacement therapy,</li>
<li class="difficult">oral hypoglycaemics,</li>
<li>acetyl salicylic acid,</li>
<li class="difficult">sulpha antibiotics,</li>
<li class="difficult">octreotide,</li>
<li class="difficult">“beta2 stimulants” (for example ritodrine, salbutamol or terbutaline),</li>
<li>beta-blockers, or</li>
<li class="difficult">some antidepressants (monoamine oxidase inhibitors or selective serotonin reuptake inhibitors),</li>
<li class="difficult">danazol,</li>
...
<p class="pregnancy breastfeeding">Are you pregnant or thinking about becoming pregnant, or are you breast-feeding? The amount of
...
have: </p>
<ul>
<li class="difficult">frequent episodes of hypoglycaemia</li>
...
<ul>
<li class="diabetes">You should normally inject Humalog Mix50 within 15 minutes of a meal. If you need to, you
...
<li class="difficult">Inject Humalog Mix50 under the skin. You should not administer it using a different
administration route. Under no circumstances should Humalog Mix50 be given intravenously.</li>
</ul>
<p class="difficult"><strong>Preparing Humalog Mix50</strong></p>
<ul>
...
<p class="difficult"><strong>After injecting</strong></p>
<ul>
...
<p class="difficult"><strong>Further injections</strong></p>
<ul>
...
blood sugar may occur. Check your blood sugar</p>
<p class="difficult">If hypoglycaemia (low blood sugar) or hyperglycaemia (high blood sugar) is not treated they can be
...
<p class="difficult"><strong>Three simple steps</strong> to avoid hypoglycaemia or hyperglycaemia are:</p>
<ul>
...
<p>If you have any further questions on the use of this product, ask your doctor or pharmacist</p></div></body></html>
"""
...
<ul>
<li class="rash">rash over the whole body</li>
<li>blood pressure dropping</li>
<li class="difficult">difficulty in breathing </li>
<li>heart beating fast</li>
<li class="difficult">wheezing </li>
<li class="difficult">sweating</li>
</ul>
...
this medicine.</p>
<p class="diabetes difficult"><strong>Common problems of diabetes</strong></p>
<p class="difficult"><strong>A. Hypoglycaemia</strong></p>
...
<li class="difficult">you have an infection or illness (especially diarrhoea or vomiting);</li>
...
<li class="difficult">nervousness or shakiness</li>
<li>feeling sick</li>
<li>headache</li>
<li>cold sweat.
...
<p class="difficult"><strong>B. Hyperglycaemia and diabetic ketoacidosis</strong></p>
...
‘sick rules’, and tell your doctor.</p> </div></body></html>
"""      
...
* section[=].section[+]
  ...
  * text.div = """
<html><body><div xmlns="http://www.w3.org/1999/xhtml">
<p class="children">Before the first use store your Humalog Mix50 in a refrigerator (2°C – 8°C). Do not freeze.
...
dispose of medicines no longer required. These measures will help to protect the environment.</p> </div></body></html>
"""
...
* identifier.value = "6ae10ebda017e9cd47810d6f49391ea3"
* type = #document
...
// Composition
* entry[0].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/composition-en-d33868162d255ced115cecbbf188aab4-pproc"
* entry[0].resource = composition-en-d33868162d255ced115cecbbf188aab4-pproc
