Instance: composition-es-proc-bc60fa1aa0bfe774d11ee13c0c131622
...
* section[=].section[+]
  ...
  * text.status = #additional
  * text.div = """<div xmlns='http://www.w3.org/1999/xhtml'>  <p class="indication">Xenical es un medicamento utilizado para tratar la obesidad. Actúa sobre su sistema digestivo 
...
<li class="pregnancyCategory">Si está en periodo de lactancia </li>
</ul>
<p>Advertencias y precauciones</p>

<p>La pérdida de peso puede también afectar a la dosis de los medicamentos que tome para otras 
...
Instance: bundlepackageleaflet-es-proc-4fab126d28f65a1084e7b50a23200363
...
* identifier.value = "xenical-es-processed"
* type = #document
...
// Composition
* entry[0].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/composition-es-proc-bc60fa1aa0bfe774d11ee13c0c131622"
* entry[0].resource = composition-es-proc-bc60fa1aa0bfe774d11ee13c0c131622
