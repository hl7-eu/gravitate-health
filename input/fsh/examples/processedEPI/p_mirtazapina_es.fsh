Instance: composition-es-proc-7a7ff0f4e1993c2fdabba6c8d9931a52
...
<p  class="indication">Mirtazapina se utiliza para tratar la depresión en adultos.</p>
...
<p  class="pregnancyCategory"><strong>Embarazo y lactancia</strong></p>
<p class="pregnancyCategory">Si está embarazada o en periodo de lactancia, cree que podría estar embarazada o tiene intención de
quedarse embarazada, consulte a su médico o farmacéutico antes de utilizar este medicamento.</p>
<p class="pregnancyCategory">La experiencia limitada de la administración de mirtazapina a mujeres embarazadas no indica un aumento
de riesgo. Sin embargo, debe tenerse cuidado si se usa durante el embarazo.</p>
<p class="pregnancyCategory">Si usa mirtazapina hasta, o poco antes del parto, su hijo será examinado para detectar posibles efectos
adversos.</p>
<p> class="pregnancyCategory"Tomados durante el embarazo, los medicamentos similares (ISRS) pueden aumentar en los bebés el riesgo
...
Instance: bundlepackageleaflet-es-proc-e762a2f54b0b24fca4744b1bb7524a5b
...
// Composition
* entry[0].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/composition-es-proc-7a7ff0f4e1993c2fdabba6c8d9931a52"
* entry[0].resource = composition-es-proc-7a7ff0f4e1993c2fdabba6c8d9931a52
