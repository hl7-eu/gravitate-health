Instance: composition-es-ac2bb08bb4cc3f51f8c4e3513034c019-pproc
...
* section[=].section[+]
  ...
  * text.div = """
<html><body><div xmlns="http://www.w3.org/1999/xhtml"> <div>
<p><span></span></p>
...
<p><span>2. Qué necesita saber antes de empezar a tomar Tegretol</span></p>
<p><span>3. Cómo tomar Tegretol</span></p>
...
<p><span>Lea las siguientes instrucciones antes de tomar Tegretol.</span></p>
...
<li><span>Si sufre o ha sufrido en el pasado alguna enfermedad grave de la sangre;</span></li>
<li class="difficult"><span class="difficult">Si tiene problemas en la formación de porfirina, pigmento importante para la función hepática y la formación de sangre (también llamada porfiria hepática);</span></li>
...
<li><span>si tiene la presión intraocular elevada (glaucoma), disminución de las ganas de orinar o dificultad para orinar</span><span>;</span></li>
<li><span>si padece una enfermedad mental llamada psicosis, y también si es usted mayor y padece confusión o agitación;</span></li>
<li><span>si aparecen signos que sugieran una enfermedad grave de la piel;</span></li>
<li><span>si ha observado alteraciones de la sensibilidad (erupción cutánea u otros signos de alergia) a la oxcarbazepina o a otros medicamentos, como fenitoína (otro antiepiléptico). Es importante mencionar que si es alérgico a la carbamazepina, las posibilidades son de 1 entre 4 (25%) de que pueda tener una reacción alérgica a la oxcarbazepina (Trileptal).</span></li>
<li><span>si es una mujer en edad fértil debe usar un método anticonceptivo eficaz durante todo su tratamiento y durante dos semanas después de que haya tomado su última dosis. Si</span> <span class="pregnancy">toma anticonceptivos orales, Tegretol puede hacer que los anticonceptivos no sean eficaces. Por lo tanto, se deberían usar métodos anticonceptivos no hormonales distintos o adicionales mientras toma Tegretol. Esto ayudará a evitar embarazos no deseados. Consulte a su médico si presenta sangrados irregulares o manchados mientras esté tomando Tegretol. Si tiene cualquier duda, consulte con su médico.</span></li>
<li><span class="pregnancy">Informe a su médico si usted está embarazada o tiene intención de quedarse embarazada. Su médico le informará sobre el riesgo potencial de tomar Tegretol durante el embarazo ya que puede producir daños o anormalidades en el feto. Existe riesgo de daños para el feto si se utiliza Tegretol durante el embarazo. Las mujeres en edad fértil deben utilizar un método anticonceptivo eficaz durante el tratamiento con Tegretol y durante dos semanas después de la última dosis (ver sección embarazo, lactancia y fertilidad).</span></li>
</ul>
...
<li><span>Si nota síntomas sugestivos de hepatitis, como ictericia (piel y blanco de los ojos amarillento), consulte a su médico inmediatamente.</span></li>
<li><span>Si en cualquier momento tiene pensamientos de hacerse daño o matarse. Un pequeño número de pacientes tratados con antiepilépticos sufren de tales pensamientos o comportamientos.</span></li>
<li class="difficult"><span class="difficult">Si tiene problemas de riñón asociados con bajos niveles de sodio en sangre o si tiene problemas de riñón y está tomando medicinas que le bajen los niveles de sodio en sangre (diuréticos como hidroclorotiazida, furosemida).</span></li>
...
<p class="difficult"><span class="difficult">Informe a su médico o farmacéutico si está tomando, ha tomado recientemente o pudiera tener que tomar cualquier otro medicamento. Tegretol puede presentar múltiples interacciones con un gran número de medicamentos que pueden tanto aumentar como disminuir su efecto y el de dichos medicamentos. Esta advertencia es válida para medicamentos adquiridos con y sin receta médica y especialmente en el caso de vitaminas (Vitamina B3), anticonceptivos orales, analgésicos como el paracetamol, preparados que contengan hierba de San Juan</span> <a name="_Hlk90458991"><span>y otros medicamentos para la epilepsia (como brivaracetam)</span></a><span>.</span></p>
<p><span>Durante el tratamiento con Tegretol evite usar medicamentos que contengan alcohol.</span></p>
<p><u><span>Anticonceptivos hormonales, por ejemplo, píldoras, parches, inyecciones o implantes</span></u></p>
<p><span class="pregnancy">Tegretol puede afectar al funcionamiento de los anticonceptivos hormonales, haciendo que sean menos eficaces para prevenir el embarazo. Consulte a su médico, quien le explicará el tipo de anticonceptivo más adecuado que puede usar mientras esté tomando Tegretol.</span></p>
<p><strong><span>Uso de Tegretol con alimentos y bebidas</span></strong></p>
<p><span>Puede tomar Tegretol con o sin alimentos.</span></p>
<p><span>Debe evitar el consumo de alcohol durante el tratamiento con Tegretol. El alcohol puede aumentar el riesgo de efectos adversos.</span></p>
...
<p><span>En general, la dosis inicial en adultos para el tratamiento de la</span> <strong><span>epilepsia</span></strong> <span>es de 100-200 mg una o dos veces al día; esta dosis se va aumentando gradualmente hasta 800-1200 mg al día (en algunos pacientes puede ser necesaria una dosis de 1600 mg al día), dividida en 2 ó 3 tomas fraccionadas.</span></p>
<p><span>El tratamiento en niños suele iniciarse con una dosis de 100-200 mg al día (10-20 mg/kg/día) y se aumenta progresivamente hasta 400-600 mg. Los adolescentes pueden recibir entre 600 y 1000 mg al día.</span></p>
<p><span>Para el tratamiento de la</span> <strong><span>neuralgia del trigémino,</span></strong> <span>la dosis inicial es de 200-400 mg diarios aumentándose lentamente hasta que desaparece el dolor, generalmente 200 mg 3-4 veces al día. La dosis máxima es de 1200 mg al día. En pacientes de edad avanzada se recomienda una dosis inicial más baja (100 mg dos veces al día).</span></p>
<p><span>Para el</span> <strong><span>tratamiento de la manía y para la prevención de los trastornos afectivos bipolares,</span></strong> <span>la dosis habitual es de 400-600 mg al día (el margen de dosis oscila entre aprox. 400 y 1600 mg diarios).</span></p>
...
<p class="difficult"><span class="difficult">En caso de sobredosis por Tegretol, comuníquelo inmediatamente a su médico. Puede necesitar atención médica. Si experimenta dificultad respiratoria, ritmo cardíaco rápido e irregular, pérdida de conocimiento, temblores, mareos, náuseas y/o vómitos puede que esté tomando una dosis demasiado alta de Tegretol. Informe inmediatamente al médico.</span></p>
<p class="difficult"><span class="difficult">Si ha tomado más Tegretol del que debe, consulte inmediatamente a su médico, a su farmacéutico o llame al Servicio de Información Toxicológica, teléfono: 91 562 04 20, indicando el medicamento y la cantidad utilizada.</span></p>
<p><strong><span></span></strong></p>
...
* section[=].section[+]
  ...
  * text.div = """
<html><body><div class="difficult" xmlns="http://www.w3.org/1999/xhtml"> <div class="difficult">
...
<p><span>Son más frecuentes especialmente al inicio del tratamiento, si la dosis es demasiado alta o en</span> <span>algunas personas como los ancianos, y suelen desaparecer al cabo de unos días de tratamiento o tras un ajuste de la dosis.</span></p>
...
<li><span>si presenta erupción de la piel con manchas rojizas normalmente en la cara que puede estar acompañado de fatiga, náuseas, pérdida de apetito (signo de lupus erimatoso sistémico)</span></li>
<li><span>si presenta amarilleo del blanco de los ojos o de la piel (signo de hepatitis)</span></li>
<li><span>si presenta oscurecimiento de la orina (signos de porfiria o hepatitis)</span></li>
<li><span>si presenta disminución de la cantidad de orina o sangre en la orina (signos de alteraciones en el riñón)</span></li>
...
<li class="difficult"><span class="difficult">si padece hinchazón en la cara, ojos, o lengua, dificultad para tragar, jadeos, urticaria y picor generalizado, erupción cutánea, fiebre, calambres abdominales, molestias u opresión en el pecho, dificultad para respirar, inconsciencia (signos de angioedema y de reacciones alérgicas graves)</span></li>
<li class="difficult"><span class="difficult">si presenta letargia, confusión, tics musculares o empeoramiento significativo de las convulsiones (signos que pueden estar asociados a niveles bajos de sodio en la sangre)</span></li>
<li><span>si presenta fiebre, náuseas, vómitos, dolor de cabeza, rigidez del cuello o sensibilidad extrema a la luz brillante (signos de meningitis)</span></li>
<li><span>si padece rigidez muscular, fiebre alta, alteraciones de la consciencia, aumento de la presión sanguínea, exceso de salivación (signos de síndrome neuroléptico maligno)</span></li>
<li><span>si presenta ritmo cardíaco irregular, dolor de pecho</span></li>
<li><span>si presenta alteración de la conciencia, desvanecimiento</span></li>
<li><span>si presenta diarrea, dolor abdominal y fiebre (signos de una inflamación de colón). Se desconoce la frecuencia de este efecto adverso</span></li>
...
<p><strong><span></span></strong></p>
<p class="difficult"><em><span>Efectos adversos muy frecuentes (</span></em><em><span>pueden afectar a más de 1 de cada 10 pacientes</span></em><em><span>)</span></em><strong><span>:</span></strong> <span>pérdida de la coordinación muscular,</span> <span class="difficult">inflamación de la piel con erupción cutánea con picor y enrojecimiento, erupción cutánea con picazón, vómitos, náuseas, mareos, somnolencia, inestabilidad, aumento de peso.</span></p>
<p><span></span></p>
<p class="difficult"><em><span>Efectos adversos frecuentes</span></em> <em><span>(pueden afectar hasta 1 de cada 10 pacientes)</span></em><strong><span>:</span></strong> <span class="difficult">hinchazón de tobillos, pies y piernas (edema), cambios en el comportamiento, confusión, debilidad, aumento de las crisis epilépticas (brotes, debido a una cantidad insuficiente de sodio en el cuerpo), dolor de cabeza, sequedad de boca.</span></p>
<p><span></span></p>
<p class="difficult"><em><span>Efectos adversos poco frecuentes</span></em> <em><span>(pueden afectar hasta 1 de cada 100 pacientes)</span></em><strong><span>:</span></strong> <span>Temblores, movimientos incontrolados anormales, espasmos musculares.</span></p>
<p><span></span></p>
<p class="difficult"><em><span>Efectos adversos raros (pueden afectar hasta 1 de cada 1.000 pacientes):</span></em> <span class="difficult">picores, hinchazón de las glándulas, agitación u hostilidad (especialmente en los ancianos), dificultad para hablar o farfulleo, depresión con inquietud, nerviosismo u otros cambios de humor o mentales, alucinaciones,</span> <span>visión borrosa, visión doble, picor con enrojecimiento e hinchazón en los ojos (conjuntivitis), sensación de presión/dolor en los ojos (signo de aumento de presión en los ojos), movimientos involuntarios de los ojos,</span> <span class="difficult">zumbidos u otros ruidos no explicables, descenso de la audición, ritmo cardíaco rápido o inusualmente lento, adormecimiento u hormigueo en las manos y pies, debilidad, aumento de la frecuencia urinaria, disminución repentina de la cantidad de orina, trastornos del gusto, secreción inusual de leche, aumento del tamaño del pecho en los hombres, hinchazón y enrojecimiento a lo largo de una vena muy sensible al tacto y frecuentemente dolorosa (tromboflebitis), aumento de la sensibilidad de la piel al sol, debilitamiento de los huesos causando un aumento del riesgo de fractura (falta de vitamina D, osteoporosis), estreñimiento, diarrea, dolor abdominal, dolor en las articulaciones o músculos, aumento de la sudoración, pérdida de apetito, pérdida de pelo, vello corporal y facial excesivo, alteraciones sexuales, infertilidad masculina, enrojecimiento e irritación de la lengua, llagas en la boca, alteraciones en la pigmentación de la piel, acné y reacciones graves en la piel.</span></p>
<p><span></span></p>
<p class="difficult"><em><span>Efectos adversos de frecuencia no conocida (no puede estimarse a partir de los datos disponibles):</span></em> <span>reactivación de la infección del virus del herpes (puede ser grave con el sistema inmunitario deprimido), pérdida completa de las uñas, fractura de huesos, disminución de la densidad ósea, sedación</span><span>, pérdida de memoria, pápulas de color morado o granate que pueden producir picor,</span> <a name="_Hlk90459140"><span class="difficult">niveles elevados de amoniaco en sangre (hiperamonemia). Los síntomas de hiperamonemia pueden consistir en irritabilidad, confusión, vómitos, pérdida del apetito y somnolencia</span></a><span>.</span></p>
<p><strong><span>Comunicación de efectos adversos</span></strong></p>
<p class="difficult"><span>Si experimenta cualquier tipo de efecto adverso, consulte a su médico o farmacéutico, incluso si se trata de posibles efectos adversos que no aparecen en este prospecto. También puede comunicarlos directamente a través del</span> <span>Sistema Español de Farmacovigilancia de medicamentos de Uso Humano</span><span>:</span> <a href="https://www.notificaRAM.es"><u><span>https://www.notificaRAM.es</span></u></a><span>.</span> <span class="difficult">Mediante la comunicación de efectos adversos usted puede contribuir a proporcionar más información sobre la seguridad de este medicamento.</span></p>
</div> </div></body></html>
"""
...
<p><span>Tegretol 200 mg comprimidos se presenta en envases blíster que contienen 50,100 y 500 comprimidos blancos, redondos, con ranura en un lado, marcados “CG” en una cara y “G” y “K” en la otra cara a ambos lados de la ranura.</span></p>
...
<p><span>Novartis Farma S.p.A</span></p>
<p><span>Via provinciale Schito 131</span></p>
<p><span>I-80058 Torre Annunziata</span></p>
...
// originally: bundlepackageleaflet-es-2f37d696067eeb6daf1111cfc3272672
Instance: bundlepackageleaflet-es-2f37d696067eeb6daf1111cfc3272672-pproc
...
// Composition
* entry[0].fullUrl = "http://hl7.eu/fhir/ig/gravitate-health/Composition/composition-es-ac2bb08bb4cc3f51f8c4e3513034c019-pproc"
* entry[0].resource = composition-es-ac2bb08bb4cc3f51f8c4e3513034c019-pproc
