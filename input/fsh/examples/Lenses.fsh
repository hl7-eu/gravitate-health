...
* name.extension[=].extension[=].valueCode = #es
...
* topic = lens-categories-cs#IPS "IPS"
...
* description.extension[=].extension[=].valueCode = #es
...
* purpose.extension[=].extension[=].valueCode = #es
...
* content.title = "Lens for pregnancy"
