...
Title: "Composition for CALCIO/VITAMINA D3 ROVI 1000 mg/880 UI COMPRIMIDOS EFERVESCENTES Package Leaflet - Enhanced for Pedro"
Description:  "Composition for CALCIO/VITAMINA D3 ROVI 1000 mg/880 UI COMPRIMIDOS EFERVESCENTES Package Leaflet - Enhanced for Pedro"
Usage: #inline
...
<p>-Este medicamento se le ha recetado solamente a usted, y no debe d árselo a otras personas aunque tengan los mismos síntomas que usted, ya que puede perjudicarles.</p>
...
<li>Conservación de Calcio/Vitamina D3 ROVI</li>
...
<li>si usted tiene litiasis c álcica (c álculos en riñones), calcificación tisular (depósito de sales de calcio en los tejidos),</li>
...
<p></p>
<p>Si toma m ás Calcio/Vitamina D3 ROVI del que debe, o en caso de sobredosis o ingestión accidental, consulte inmediatamente a su médico o farmacéutico o llame al Servicio de Información Toxicológica, teléfono: 91.562.04.20, indicando el medicamento y la cantidad ingerida.</p>
<p>La sobredosis puede provocar hipervitaminosis D (exceso de vitamina D) e hipercalcemia (nivel de calcio anormalmente elevado en sangre). Los síntomas en caso de sobredosis son: n áuseas, vómitos, anorexia (trastorno de la alimentación), dolor en el abdomen, sequedad de boca o poliuria (aumento del volumen de orina eliminado), o bien, irritabilidad, letargia (cansancio excesivo), estupor (disminución de la respuesta a los estímulos) y coma (pérdida de la conciencia) en casos severos.</p>
<p></p>
