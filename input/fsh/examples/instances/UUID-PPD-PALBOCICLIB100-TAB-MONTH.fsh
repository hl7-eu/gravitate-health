Instance: UUID-PPD-PALBOCICLIB100-TAB-MONTH
InstanceOf: PackagedProductDefinition
Usage: #inline
* identifier.use = #official
* identifier.system = "http://hl7.org/fhir/sid/ndc"
* identifier.value = "NDC:0069-0486-03"
* name = "100 MG TABLET DOSE PACK CARTON"
...
* packaging.identifier.value = "NDC:0069-0486-03"
