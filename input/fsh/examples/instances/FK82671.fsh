...
Usage: #example
Description: "REMICADE kuiva-aine välikonsentraatiksi infuusionestettä varten, liuos 100 mg"
* language = #fi
...
* entry[=].resource = IBD-PPD-22
* entry[+].fullUrl = "https://gravitatehealth.eu/fhir/nordic-epi/PackagedProductDefinition/IBD-PPD-23"
* entry[=].resource = IBD-PPD-23