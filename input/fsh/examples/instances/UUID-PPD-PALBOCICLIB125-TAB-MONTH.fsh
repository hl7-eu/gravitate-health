Instance: UUID-PPD-PALBOCICLIB125-TAB-MONTH
InstanceOf: PackagedProductDefinitionUvEpi
Usage: #inline
* identifier.use = #official
* identifier.system = "http://hl7.org/fhir/sid/ndc"
* identifier.value = "NDC:0069-0688-03"
* name = "125 MG TABLET DOSE PACK CARTON"
...
* packaging.identifier.value = "NDC:0069-0688-03"
