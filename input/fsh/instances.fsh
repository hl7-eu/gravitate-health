...
* rest.resource[=].operation.definition = "https://gravitate-health-lens.gravitate.tcs.trifork.dev/fhir/OperationDefinition/ConceptMap-it-translate"
...
* rest.operation[=].definition = "http://hl7.eu/fhir/ig/gravitate-health/OperationDefinition/diff"
