...
def create_list(clean_content):
    ...
    parts = [
        ...
        "Pakningsstørrelser og yderligere information\s*",
        "Pakningsstørelser og yderligere information\s*",
        "Pakkens indhold og yderligere oplysninger\s*",
        "Det skal du vide, før du begynder får .+\s*",
        "Det du skal vide, før du begynder at tage .+\s*",
        "Det skal du vide, før de begynder at bruge .+\s*",
        "Det skal du vide, før du begynder at  tage .+\s*",
        "Det skal du vide, før du \(eller dit barn\) får .+\s*",
        "Det skal du vide, før du eller dit barn begynder at få .+\s*",
        ...
        "Det skal du vide, før dit barn får .+\s*",
        "Det skal du vide, før dit barn vaccineres med .+\s*",
        ...
        "Det skal de vide, før Deres spædbarn begynder at få .+\s*",
        "Det skal du vide, før du bliver behandlet med .+\s*",
        "Det skal De vide, før Deres barn begynder at tage .+\s*",
        "Det skal du vide, før du bliver undersøgt med .+\s*",
        "Det skal du vide, før .+ anvendes\s*",
        "Sådan skal .+ anvendes\s*",
        "Sådan anvendes .+\s*",
        "Sådan skal Deres barn tage .+\s*",
        "Sådan bliver dit barn vaccineret med .+\s*",
        "Sådan får dit barn .+\s*",
